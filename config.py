...
CONTAINER_MEM_LIMIT = os.getenv("CONTAINER_MEM_LIMIT", "256m")
CONTAINER_CPU_LIMIT = float(os.getenv("CONTAINER_CPU_LIMIT", "0.5"))  # Fraction of CPU core limit (e.g. 0.5 cores)
